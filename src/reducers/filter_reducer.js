...
const filter_reducer = (state, action) => {
  if (action.type === LOAD_PRODUCTS) {
    ...
    let min_price = Math.min(...max_price);
    ...
    return {
      ...
      filters: { ...state.filters, min_price, max_price, price: max_price },
    };
  }
  ...
  if (action.type === FILTER_PRODUCTS) {
    ...
    const { text, company, price, category, color, shipping } = state.filters;
